...
def extract_training_and_test_examples_with_labels(train_x, train_y, test_x, test_y, labels, training_count,
                                                   test_count):
...
def get_mnist_data():
    ...
    """
    train_set, valid_set, test_set = read_pickle_data('../dataset/mnist/mnist.pkl.gz')
